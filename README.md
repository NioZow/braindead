...
- Choosing the video : after work, or when eating alone, I just want my brain to chill the _fck_ out and so often search YouTube for videos meanwhile. Choosing a video is a real headache, and you can easily get distracted so this project chooses and tracks the videos for you.
...
- Notetaking : watching content is great, however, I personally don't remember much of what I watch but don't feel like taking notes, as the main goal is to chill the _fck_ out. So I've integrated AI to sum up the videos for me and directly write those to markdown to my notes folder.
...
```sh
brainless highlight ~/Downloads/kindle.html --kindle
```
