...
description: Convert technical articles, videos, documentation, and educational content into structured, actionable reference notes
license: MIT
metadata:
...
Specialized skill for converting technical articles, videos, documentation, and educational content into structured, actionable reference notes.
...
- Research papers
- Any technical content that needs structured notes
...
- "process this technical content"
- "summarize into notes"
- User provides URL to article/video and asks for summary
...
- **Cybersecurity**: Vulnerabilities, exploits, penetration testing, security tools, threat analysis
- **Artificial Intelligence & Machine Learning**: Models, algorithms, training techniques, applications, research
- **Finance & Trading**: Investment strategies, market analysis, financial tools, trading techniques, economic insights
- **Entrepreneurship & Business**: Startup strategies, business models, growth tactics, market insights
- **Productivity & Self-Development**: Workflows, habits, systems, mental models, time management

## How to Use This Skill

1. **Gather content**: Get the article text, video transcript, or URL
2. **If URL provided**: Use the `braindead fetch` command or helper scripts to fetch content
   - Article: `braindead fetch <url> --article --json`
   - YouTube: `braindead fetch <url> --video --json`
3. **Prepare metadata**: Extract relevant information (title, author, date, URL)
4. **Apply prompt template**: Use the prompt template provided below with the content and metadata
5. **Format output**: Return as structured markdown notes

## Prompt Template

Use this prompt template when processing content:
...
- Preserved technical details, numbers, and code
- Well-organized sections matching the template
...
- Inherits conversation context about the content
- Sensitive to domain-specific requirements
````
